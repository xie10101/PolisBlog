      ...
      <main className="flex flex-col flex-1 gap-6">
        ...
        <main className="grid grid-cols-2 gap-4">
           <Card>
                 <CardHeader>
                  <div>
                     <p className="text-lg font-bold"> Recently Published Articles</p>
                     <p className="text-sm text-gray-500"> Latest articles from your blog</p>
                  </div>
             ...
             <Card> 
                  ...
                  <div>
                     ...
                     <p className="text-sm text-gray-500">Recent comments on your articles</p>
                  </div>
                  <CardContent className="flex-row">
                    <Table>
                      <TableCaption>A list of your recent invoices.</TableCaption>
